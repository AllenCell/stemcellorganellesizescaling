...
def initial_parsing(
    ...
    if platform.system() == "Linux":
        ...
        keepcolumns = [
            "CellId",
            "structure_name",
            "mem_roundness_mesh_surface_area",
            "mem_shape_mesh_volume",
            "dna_roundness_mesh_surface_area",
            "dna_shape_mesh_volume",
            "str_connectivity_number_cc",
            "str_shape_mesh_volume",
            "mem_position_mesh_depth",
            "mem_position_height",
            "mem_position_width",
            "dna_position_mesh_depth",
            "dna_position_height",
            "dna_position_width",
            "DNA_MEM_PC1",
            "DNA_MEM_PC2",
        ...
        cells = cells.rename(
            columns={
                "mem_roundness_mesh_surface_area": "Cell surface area",
                "mem_shape_mesh_volume": "Cell volume",
                "dna_roundness_mesh_surface_area": "Nuclear surface area",
                "dna_shape_mesh_volume": "Nuclear volume",
                "str_connectivity_number_cc": "Number of pieces",
                "str_shape_mesh_volume": "Structure volume",
                "mem_position_mesh_depth": "Cell height",
                "mem_position_height": "Cell xbox",
                "mem_position_width": "Cell ybox",
                "dna_position_mesh_depth": "Nucleus height",
