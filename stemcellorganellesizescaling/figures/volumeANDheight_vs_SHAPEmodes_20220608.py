...
if save_flag:
    # %% Finalize plotting
    if pt=='all':
        plot_save_path = pic_root / f"shapemodes_v20220608_res300_ALL.png"
        plt.savefig(plot_save_path, format="png", dpi=300)
        plt.show()
        print('ok')
    elif pt=='png':
        plot_save_path = pic_root / f"shapemodes_v20220608_res600.png"
        plt.savefig(plot_save_path, format="png", dpi=600)
        plt.close()
    elif pt=='svg':
        plot_save_path = pic_root / f"shapemodes_v20220608.svg"
