...
fs2 = 14
FS = {}
FS["ShapeModes"] = ["NUC_MEM_PC1","NUC_MEM_PC2","NUC_MEM_PC3","NUC_MEM_PC4","NUC_MEM_PC5","NUC_MEM_PC6","NUC_MEM_PC7","NUC_MEM_PC8"]
FS["Shape Mode Names"] = ['Shape Mode 1','Shape Mode 2','Shape Mode 3','Shape Mode 4','Shape Mode 5','Shape Mode 6','Shape Mode 7','Shape Mode 8']
FS["Shape Mode Types"] = ['pca','pca','pca','pca','pca','pca','pca','pca']
FS["Cell Metrics"] = ["Cell volume",'Cell height']
FS["Cell Metrics Name"] = ["Cell Volume",'Cell Height']
FS["Cell Metrics Types"] = ['vol','height']
ps = data_root / statsIN / "cell_nuc_PCA_metrics"
...
for col, (c_feat, c_name, c_type) in enumerate(zip(FS["Cell Metrics"], FS["Cell Metrics Name"],FS["Shape Mode Types"])):
    for row, (r_feat, r_name, r_type) in enumerate(zip(FS["ShapeModes"], FS["Shape Mode Names"],FS["Shape Mode Types"])):
