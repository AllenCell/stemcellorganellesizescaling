...
for j,ncm in enumerate(FS["cellnuc_metrics"]):
    ...
    res_table.iat[i+2,2] = 'Q1'
    res_table.iat[i+2,3] = np.median(xc)
    res_table.iat[i+2,4] = 'Q3'
    res_table.iat[i+2,5] = len(nc)
    res_table.iat[i+2,6] = 'Q1'
    res_table.iat[i+2,7] = 'median'
    res_table.iat[i+2,8] = 'Q3'
    res_table.iat[i+2,9] = len(ec)
    res_table.iat[i+2,10] = 'Q1'
    res_table.iat[i+2,11] = 'median'
    res_table.iat[i+2,12] = 'Q3'
    res_table.iat[i+2,13] = 'P-value'
    res_table.iat[i+2,14] = 'Effect size'
    res_table.iat[i+2,15] = 'P-value'
    res_table.iat[i+2,16] = 'Effect size'res_table[i+2,len(xc)]
