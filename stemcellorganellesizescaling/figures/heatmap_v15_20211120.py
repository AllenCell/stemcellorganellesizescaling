...
if PrintType=='all':
    plot_save_path = pic_root / f"heatmap_v15_20211120_res300_ALL.png"
    plt.savefig(plot_save_path, format="png", dpi=300)
    plt.show()
elif PrintType=='png':
    plot_save_path = pic_root / f"heatmap_v15_20211120_res300.png"
    plt.savefig(plot_save_path, format="png", dpi=300)
    plt.close()
elif PrintType=='svg':
    plot_save_path = pic_root / f"heatmap_v15_20211120.svg"
